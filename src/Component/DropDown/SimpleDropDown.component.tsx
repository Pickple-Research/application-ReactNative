...
/**
 * SimpleDropdown은 dropdown을 편하게 활용하도록 만든 component입니다.
 * @param
 * defaultValue: 초기에 dropdown에 보이는 값을 설정합니다.
 * data: dropdown에 들어가는 데이터를 설정합니다. 이때 String, number만 사용 가능합니다.
 * buttonStyle, dropdownStyle, rowStyle, buttonTextStyle, rowTextStyle: 추가적인 스타일 설정을 도와줍니다.
